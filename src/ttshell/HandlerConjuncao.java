...
public class HandlerConjuncao {
    ...
    public void popula() {
        ...
        caso = 1; // 1.NORMAL; 
        lc.add(new Conjuncao("outrossim", "OCSd")); // Cabe ressaltar que o réu é pessoa de boa índole e honesta, Outrossim, cumpre salientar que possui bons antecedentes e jamais participou em qualquer delito
        ...
        caso = 7;// 7.não...mas sim; // A civilização não se mede pelo aperfeiçoamento material, mas sim pela elevação moral.
        ...
        caso = 3; // 3.COM_COMPLEMENTO ora...ora, seja...seja; 
        ...
        c = new Conjuncao("quer", "OCSt"); // versão 2.9.7
        c.setCaso(3);
        c.setComplemento("quer");
        lc.add(c);
        
        c = new Conjuncao("seja", "OCSt"); // versão 2.9.2
        c.setCaso(3);
        c.setComplemento("seja");
        lc.add(c);
        
        c = new Conjuncao("já", "OCSt"); // versão 2.9.4
        c.setCaso(3);
        c.setComplemento("já");
        lc.add(c);
        
        c = new Conjuncao("talvez", "OCSt"); // versão 2.9.4
        c.setCaso(3);
        ...
        caso = 5;// 5.LOCUCAO_CONJUNTIVA (no entanto, não obstante, por isso,...) 
        //  *---------------------------------------------------------
        //  *   Locuções conjuntivas (1 ordem ) com dois elementos 
        //  *---------------------------------------------------------
        ...
        lc.add(new Conjuncao("dessa arte", "OCSc")); // incluido na versão 2.9
        lc.add(new Conjuncao("desse modo", "OCSc")); // incluido na versão 2.9
        lc.add(new Conjuncao("dessa maneira", "OCSc")); // incluido na versão 2.9
        lc.add(new Conjuncao("dessa forma", "OCSc")); // incluido na versão 2.9
        ...
        //  *---------------------------------------------------------
        //  *   Locuções conjuntivas (1 ordem ) com tres elementos 
        //  *---------------------------------------------------------
        ...
        lc.add(new Conjuncao("uma vez que", "OCSe"));   // Versão 2.9.6

        //lc.add(new Conjuncao("de modo que", "OCSe")); // =(que) ?????
        //lc.add(new Conjuncao("de sorte que", "OCSe"));
        //lc.add(new Conjuncao("de forma que", "OCSe")); 
        ...
        c = new Conjuncao("outras vezes", "OCSt"); // Versão 2.9.5
        ...
        c = new Conjuncao("outras", "O?"); // Versão 2.9.5
        c.setCaso(9);
        lc.add(c);
